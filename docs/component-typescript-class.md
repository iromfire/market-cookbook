...
✅ Single File Component – для небольших компонентов держи шаблон и стили в одном файле

❌ Не пиши бизнес логику в компоненте

✅ Подписки только через async. Или конвертация в signals (toSignal)

❌ Не делай ручные subscribe() в компоненте если этого можно избежать
